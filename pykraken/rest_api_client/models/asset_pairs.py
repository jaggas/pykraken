...
class AssetPairs:
    ...
    Attributes:
        ...
        fees_maker (Union[Unset, List[List[Union[float, int]]]]): Maker fee schedule array in `[<volume>, <percentfee>]`
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        asset_pairs.additional_properties = d
        return asset_pairs
