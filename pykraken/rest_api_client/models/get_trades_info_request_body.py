...
T = TypeVar("T", bound="GetTradesInfoRequestBody")


@attr.s(auto_attribs=True)
class GetTradesInfoRequestBody:
    """
    Attributes:
        nonce (int): Nonce used in construction of `API-Sign` header
        txid (Union[Unset, str]): Comma delimited list of transaction IDs to query info about (20 maximum)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_trades_info_request_body = cls(
            nonce=nonce,
            txid=txid,
            trades=trades,
        )

        get_trades_info_request_body.additional_properties = d
        return get_trades_info_request_body
