...
T = TypeVar("T", bound="TradeVolumeFeesMakerAdditionalProperty")


@attr.s(auto_attribs=True)
class TradeVolumeFeesMakerAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        trade_volume_fees_maker_additional_property = cls(
            fee=fee,
            min_fee=min_fee,
            max_fee=max_fee,
            next_fee=next_fee,
        ...
        trade_volume_fees_maker_additional_property.additional_properties = d
        return trade_volume_fees_maker_additional_property
