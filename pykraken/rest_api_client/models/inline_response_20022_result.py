...
from ..models.inline_response_20022_result_status import InlineResponse20022ResultStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="InlineResponse20022Result")


@attr.s(auto_attribs=True)
class InlineResponse20022Result:
    """
    Attributes:
        ...
        status (Union[Unset, InlineResponse20022ResultStatus]): Status of the report
    ...
    status: Union[Unset, InlineResponse20022ResultStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status: Union[Unset, InlineResponse20022ResultStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = InlineResponse20022ResultStatus(_status)
        ...
        inline_response_20022_result = cls(
            id=id,
            descr=descr,
            format_=format_,
            report=report,
        ...
        inline_response_20022_result.additional_properties = d
        return inline_response_20022_result
