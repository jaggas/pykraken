...
from ..models.cancel_order_response_200_order_cancelled import CancelOrderResponse200OrderCancelled
...
class CancelOrderResponse200:
    ...
    Attributes:
        result (Union[Unset, CancelOrderResponse200OrderCancelled]):
        error (Union[Unset, List[List[str]]]):
    """

    result: Union[Unset, CancelOrderResponse200OrderCancelled] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_result, Unset):
            ...
            result = CancelOrderResponse200OrderCancelled.from_dict(_result)
