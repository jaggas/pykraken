...
T = TypeVar("T", bound="GetAssetInfoResponse200ResultAssetInfo")


@attr.s(auto_attribs=True)
class GetAssetInfoResponse200ResultAssetInfo:
    """Asset Info
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_asset_info_response_200_result_asset_info = cls(
            aclass=aclass,
            altname=altname,
            decimals=decimals,
        ...
        get_asset_info_response_200_result_asset_info.additional_properties = d
        return get_asset_info_response_200_result_asset_info
