...
T = TypeVar("T", bound="GetDepositMethodsResponse200DepositMethod")


@attr.s(auto_attribs=True)
class GetDepositMethodsResponse200DepositMethod:
    """Deposit Method
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_deposit_methods_response_200_deposit_method = cls(
            method=method,
            limit=limit,
            fee=fee,
        ...
        get_deposit_methods_response_200_deposit_method.additional_properties = d
        return get_deposit_methods_response_200_deposit_method
