...
T = TypeVar("T", bound="GetOrderBookResponse200ResultOrderBook")


@attr.s(auto_attribs=True)
class GetOrderBookResponse200ResultOrderBook:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_order_book_response_200_result_order_book = cls(
            asks=asks,
            bid=bid,
        )

        get_order_book_response_200_result_order_book.additional_properties = d
        return get_order_book_response_200_result_order_book
