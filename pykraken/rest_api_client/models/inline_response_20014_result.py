...
T = TypeVar("T", bound="InlineResponse20014Result")
...
class InlineResponse20014Result:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        inline_response_20014_result = cls()
        ...
        inline_response_20014_result.additional_properties = additional_properties
        return inline_response_20014_result
