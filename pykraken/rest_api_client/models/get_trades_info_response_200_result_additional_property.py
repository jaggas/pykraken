...
from ..models.get_trades_info_response_200_result_additional_property_ordertype import (
    GetTradesInfoResponse200ResultAdditionalPropertyOrdertype,
)
from ..models.get_trades_info_response_200_result_additional_property_posstatus import (
    GetTradesInfoResponse200ResultAdditionalPropertyPosstatus,
)
from ..models.get_trades_info_response_200_result_additional_property_type import (
    GetTradesInfoResponse200ResultAdditionalPropertyType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetTradesInfoResponse200ResultAdditionalProperty")


@attr.s(auto_attribs=True)
class GetTradesInfoResponse200ResultAdditionalProperty:
    """
    Attributes:
        ...
        type (Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyType]): Order side
              * buy - buy side
              * sell - sell side
        ordertype (Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyOrdertype]):
        ...
        posstatus (Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyPosstatus]): Position status
            (open/closed) <br><sub><sup>Only present if trade opened a position</sub></sup>
    ...
    type: Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyType] = UNSET
    ordertype: Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyOrdertype] = UNSET
    ...
    posstatus: Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyPosstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = GetTradesInfoResponse200ResultAdditionalPropertyType(_type)
        ...
        if isinstance(_ordertype, Unset):
            ...
            ordertype = GetTradesInfoResponse200ResultAdditionalPropertyOrdertype(_ordertype)
        ...
        posstatus: Union[Unset, GetTradesInfoResponse200ResultAdditionalPropertyPosstatus]
        if isinstance(_posstatus, Unset):
            posstatus = UNSET
        else:
            posstatus = GetTradesInfoResponse200ResultAdditionalPropertyPosstatus(_posstatus)
        ...
        get_trades_info_response_200_result_additional_property = cls(
            ordertxid=ordertxid,
            pair=pair,
            time=time,
            type=type,
        ...
        get_trades_info_response_200_result_additional_property.additional_properties = d
        return get_trades_info_response_200_result_additional_property
