...
T = TypeVar("T", bound="ClosedOrdersClosed")


@attr.s(auto_attribs=True)
class ClosedOrdersClosed:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        closed_orders_closed.additional_properties = additional_properties
        return closed_orders_closed
