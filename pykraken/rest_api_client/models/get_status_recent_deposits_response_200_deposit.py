...
from ..models.get_status_recent_deposits_response_200_deposit_status_prop import (
    GetStatusRecentDepositsResponse200DepositStatusProp,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetStatusRecentDepositsResponse200Deposit")


@attr.s(auto_attribs=True)
class GetStatusRecentDepositsResponse200Deposit:
    """Deposit
    ...
    Attributes:
        ...
        status_prop (Union[Unset, GetStatusRecentDepositsResponse200DepositStatusProp]): Addition status properties
            <sup><sub>(if available)</sup></sub><br>
    ...
    status_prop: Union[Unset, GetStatusRecentDepositsResponse200DepositStatusProp] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_prop: Union[Unset, GetStatusRecentDepositsResponse200DepositStatusProp]
        if isinstance(_status_prop, Unset):
            status_prop = UNSET
        else:
            status_prop = GetStatusRecentDepositsResponse200DepositStatusProp(_status_prop)

        get_status_recent_deposits_response_200_deposit = cls(
            method=method,
            aclass=aclass,
            asset=asset,
            refid=refid,
        ...
        get_status_recent_deposits_response_200_deposit.additional_properties = d
        return get_status_recent_deposits_response_200_deposit
