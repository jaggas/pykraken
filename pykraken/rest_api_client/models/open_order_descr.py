...
from ..models.open_order_descr_ordertype import OpenOrderDescrOrdertype
from ..models.open_order_descr_type import OpenOrderDescrType
from ..types import UNSET, Unset

T = TypeVar("T", bound="OpenOrderDescr")
...
class OpenOrderDescr:
    ...
    Attributes:
        ...
        type (Union[Unset, OpenOrderDescrType]): Order side
              * buy - buy side
              * sell - sell side
        ordertype (Union[Unset, OpenOrderDescrOrdertype]):
    ...
    type: Union[Unset, OpenOrderDescrType] = UNSET
    ordertype: Union[Unset, OpenOrderDescrOrdertype] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, OpenOrderDescrType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = OpenOrderDescrType(_type)
        ...
        if isinstance(_ordertype, Unset):
            ...
            ordertype = OpenOrderDescrOrdertype(_ordertype)
        ...
        open_order_descr.additional_properties = d
        return open_order_descr
