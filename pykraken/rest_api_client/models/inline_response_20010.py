...
T = TypeVar("T", bound="InlineResponse20010")
...
class InlineResponse20010:
    """
    Attributes:
        result (Union[Unset, AccountBalance]): Cash balances, exlcluding pending withdrawals
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inline_response_20010 = cls(
            result=result,
            error=error,
        )

        inline_response_20010.additional_properties = d
        return inline_response_20010
