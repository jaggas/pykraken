...
from ..models.get_ledgers_response_200_ledgers_info_ledger_additional_property_type import (
    GetLedgersResponse200LedgersInfoLedgerAdditionalPropertyType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetLedgersResponse200LedgersInfoLedgerAdditionalProperty")


@attr.s(auto_attribs=True)
class GetLedgersResponse200LedgersInfoLedgerAdditionalProperty:
    """
    Attributes:
        refid (Union[Unset, str]): Reference Id
        time (Union[Unset, float]): Unix timestamp of ledger
        type (Union[Unset, GetLedgersResponse200LedgersInfoLedgerAdditionalPropertyType]): Type of ledger entry
    ...
    type: Union[Unset, GetLedgersResponse200LedgersInfoLedgerAdditionalPropertyType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, GetLedgersResponse200LedgersInfoLedgerAdditionalPropertyType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = GetLedgersResponse200LedgersInfoLedgerAdditionalPropertyType(_type)
        ...
        get_ledgers_response_200_ledgers_info_ledger_additional_property = cls(
            refid=refid,
            time=time,
            type=type,
            subtype=subtype,
        ...
        get_ledgers_response_200_ledgers_info_ledger_additional_property.additional_properties = d
        return get_ledgers_response_200_ledgers_info_ledger_additional_property
