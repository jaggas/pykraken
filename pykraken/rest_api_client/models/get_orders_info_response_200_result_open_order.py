...
from ..models.get_orders_info_response_200_result_open_order_descr import GetOrdersInfoResponse200ResultOpenOrderDescr
from ..models.get_orders_info_response_200_result_open_order_status import GetOrdersInfoResponse200ResultOpenOrderStatus
from ..models.get_orders_info_response_200_result_open_order_trigger import (
    GetOrdersInfoResponse200ResultOpenOrderTrigger,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOrdersInfoResponse200ResultOpenOrder")


@attr.s(auto_attribs=True)
class GetOrdersInfoResponse200ResultOpenOrder:
    """Open Order

    Attributes:
        refid (Union[Unset, str]): Referral order transaction ID that created this order
        userref (Union[Unset, str]): User reference id
        status (Union[Unset, GetOrdersInfoResponse200ResultOpenOrderStatus]): Status of order
        ...
        descr (Union[Unset, GetOrdersInfoResponse200ResultOpenOrderDescr]): Order description info
        ...
        trigger (Union[Unset, GetOrdersInfoResponse200ResultOpenOrderTrigger]): Price signal used to trigger "stop-loss"
            "take-profit" "stop-loss-limit"
            "take-profit-limit" orders.
              * `last` is the implied trigger if this field is not set.
             Default: GetOrdersInfoResponse200ResultOpenOrderTrigger.LAST.
    ...
    status: Union[Unset, GetOrdersInfoResponse200ResultOpenOrderStatus] = UNSET
    opentm: Union[Unset, float] = UNSET
    starttm: Union[Unset, float] = UNSET
    expiretm: Union[Unset, float] = UNSET
    descr: Union[Unset, GetOrdersInfoResponse200ResultOpenOrderDescr] = UNSET
    ...
    trigger: Union[
        Unset, GetOrdersInfoResponse200ResultOpenOrderTrigger
    ] = GetOrdersInfoResponse200ResultOpenOrderTrigger.LAST
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status: Union[Unset, GetOrdersInfoResponse200ResultOpenOrderStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetOrdersInfoResponse200ResultOpenOrderStatus(_status)
        ...
        descr: Union[Unset, GetOrdersInfoResponse200ResultOpenOrderDescr]
        if isinstance(_descr, Unset):
            descr = UNSET
        else:
            descr = GetOrdersInfoResponse200ResultOpenOrderDescr.from_dict(_descr)
        ...
        trigger: Union[Unset, GetOrdersInfoResponse200ResultOpenOrderTrigger]
        if isinstance(_trigger, Unset):
            trigger = UNSET
        else:
            trigger = GetOrdersInfoResponse200ResultOpenOrderTrigger(_trigger)
        ...
        get_orders_info_response_200_result_open_order = cls(
            refid=refid,
            userref=userref,
            status=status,
            opentm=opentm,
        ...
        get_orders_info_response_200_result_open_order.additional_properties = d
        return get_orders_info_response_200_result_open_order
