...
T = TypeVar("T", bound="GetTradeVolumeResponse200TradeVolumeFeesFeeTierInfo")


@attr.s(auto_attribs=True)
class GetTradeVolumeResponse200TradeVolumeFeesFeeTierInfo:
    """Fee Tier Info
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_trade_volume_response_200_trade_volume_fees_fee_tier_info = cls(
            fee=fee,
            min_fee=min_fee,
            max_fee=max_fee,
            next_fee=next_fee,
        ...
        get_trade_volume_response_200_trade_volume_fees_fee_tier_info.additional_properties = d
        return get_trade_volume_response_200_trade_volume_fees_fee_tier_info
