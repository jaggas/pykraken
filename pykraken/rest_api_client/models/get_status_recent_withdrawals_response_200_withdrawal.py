...
from ..models.get_status_recent_withdrawals_response_200_withdrawal_status import (
    GetStatusRecentWithdrawalsResponse200WithdrawalStatus,
)
from ..models.get_status_recent_withdrawals_response_200_withdrawal_status_prop import (
    GetStatusRecentWithdrawalsResponse200WithdrawalStatusProp,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetStatusRecentWithdrawalsResponse200Withdrawal")


@attr.s(auto_attribs=True)
class GetStatusRecentWithdrawalsResponse200Withdrawal:
    """Withdrawal
    ...
    Attributes:
        ...
        status (Union[Unset, GetStatusRecentWithdrawalsResponse200WithdrawalStatus]): Status of withdraw<br>
        ...
        status_prop (Union[Unset, GetStatusRecentWithdrawalsResponse200WithdrawalStatusProp]): Addition status
            properties <sup><sub>(if available)</sup></sub><br>
    ...
    status: Union[Unset, GetStatusRecentWithdrawalsResponse200WithdrawalStatus] = UNSET
    status_prop: Union[Unset, GetStatusRecentWithdrawalsResponse200WithdrawalStatusProp] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status: Union[Unset, GetStatusRecentWithdrawalsResponse200WithdrawalStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetStatusRecentWithdrawalsResponse200WithdrawalStatus(_status)

        _status_prop = d.pop("status-prop", UNSET)
        status_prop: Union[Unset, GetStatusRecentWithdrawalsResponse200WithdrawalStatusProp]
        if isinstance(_status_prop, Unset):
            status_prop = UNSET
        else:
            status_prop = GetStatusRecentWithdrawalsResponse200WithdrawalStatusProp(_status_prop)

        get_status_recent_withdrawals_response_200_withdrawal = cls(
            method=method,
            aclass=aclass,
            asset=asset,
            refid=refid,
        ...
        get_status_recent_withdrawals_response_200_withdrawal.additional_properties = d
        return get_status_recent_withdrawals_response_200_withdrawal
