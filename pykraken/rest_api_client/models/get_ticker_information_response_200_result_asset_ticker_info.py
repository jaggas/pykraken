...
T = TypeVar("T", bound="GetTickerInformationResponse200ResultAssetTickerInfo")


@attr.s(auto_attribs=True)
class GetTickerInformationResponse200ResultAssetTickerInfo:
    """Asset Ticker Info
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ticker_information_response_200_result_asset_ticker_info = cls(
            a=a,
            b=b,
            c=c,
            v=v,
        ...
        get_ticker_information_response_200_result_asset_ticker_info.additional_properties = d
        return get_ticker_information_response_200_result_asset_ticker_info
