...
from ..models.get_open_orders_response_200_open_orders_open_additional_property_descr import (
    GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyDescr,
)
from ..models.get_open_orders_response_200_open_orders_open_additional_property_status import (
    GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyStatus,
)
from ..models.get_open_orders_response_200_open_orders_open_additional_property_trigger import (
    GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOpenOrdersResponse200OpenOrdersOpenAdditionalProperty")


@attr.s(auto_attribs=True)
class GetOpenOrdersResponse200OpenOrdersOpenAdditionalProperty:
    """
    Attributes:
        refid (Union[Unset, str]): Referral order transaction ID that created this order
        userref (Union[Unset, str]): User reference id
        status (Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyStatus]): Status of order
        ...
        descr (Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyDescr]): Order description info
        ...
        trigger (Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger]): Price signal used to
            trigger "stop-loss"
            "take-profit" "stop-loss-limit"
            "take-profit-limit" orders.
              * `last` is the implied trigger if this field is not set.
             Default: GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger.LAST.
    ...
    status: Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyStatus] = UNSET
    opentm: Union[Unset, float] = UNSET
    starttm: Union[Unset, float] = UNSET
    expiretm: Union[Unset, float] = UNSET
    descr: Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyDescr] = UNSET
    ...
    trigger: Union[
        Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger
    ] = GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger.LAST
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status: Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyStatus(_status)
        ...
        descr: Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyDescr]
        if isinstance(_descr, Unset):
            descr = UNSET
        else:
            descr = GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyDescr.from_dict(_descr)
        ...
        trigger: Union[Unset, GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger]
        if isinstance(_trigger, Unset):
            trigger = UNSET
        else:
            trigger = GetOpenOrdersResponse200OpenOrdersOpenAdditionalPropertyTrigger(_trigger)
        ...
        get_open_orders_response_200_open_orders_open_additional_property = cls(
            refid=refid,
            userref=userref,
            status=status,
            opentm=opentm,
        ...
        get_open_orders_response_200_open_orders_open_additional_property.additional_properties = d
        return get_open_orders_response_200_open_orders_open_additional_property
