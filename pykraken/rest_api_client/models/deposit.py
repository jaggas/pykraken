...
from ..models.deposit_status_prop import DepositStatusProp
...
class Deposit:
    ...
    Attributes:
        ...
        status_prop (Union[Unset, DepositStatusProp]): Addition status properties <sup><sub>(if
    ...
    status_prop: Union[Unset, DepositStatusProp] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_prop: Union[Unset, DepositStatusProp]
        if isinstance(_status_prop, Unset):
            status_prop = UNSET
        else:
            status_prop = DepositStatusProp(_status_prop)
