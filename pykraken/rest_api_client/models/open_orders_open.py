...
T = TypeVar("T", bound="OpenOrdersOpen")


@attr.s(auto_attribs=True)
class OpenOrdersOpen:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_orders_open.additional_properties = additional_properties
        return open_orders_open
