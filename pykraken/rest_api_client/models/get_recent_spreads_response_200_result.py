...
T = TypeVar("T", bound="GetRecentSpreadsResponse200Result")


@attr.s(auto_attribs=True)
class GetRecentSpreadsResponse200Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_recent_spreads_response_200_result = cls(
            last=last,
        )
        ...
        get_recent_spreads_response_200_result.additional_properties = additional_properties
        return get_recent_spreads_response_200_result
