...
T = TypeVar("T", bound="GetTradeVolumeResponse200TradeVolumeFeesMakerAdditionalPropertyFeesMakerAdditionalProperty")


@attr.s(auto_attribs=True)
class GetTradeVolumeResponse200TradeVolumeFeesMakerAdditionalPropertyFeesMakerAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_trade_volume_response_200_trade_volume_fees_maker_additional_property_fees_maker_additional_property = cls(
            fee=fee,
            min_fee=min_fee,
            max_fee=max_fee,
            next_fee=next_fee,
        ...
        get_trade_volume_response_200_trade_volume_fees_maker_additional_property_fees_maker_additional_property.additional_properties = (
            d
        )
        return get_trade_volume_response_200_trade_volume_fees_maker_additional_property_fees_maker_additional_property
