...
T = TypeVar("T", bound="GetOHLCDataResponse200Result")


@attr.s(auto_attribs=True)
class GetOHLCDataResponse200Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ohlc_data_response_200_result = cls(
            last=last,
        )
        ...
        get_ohlc_data_response_200_result.additional_properties = additional_properties
        return get_ohlc_data_response_200_result
