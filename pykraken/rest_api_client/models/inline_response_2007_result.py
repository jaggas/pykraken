...
T = TypeVar("T", bound="InlineResponse2007Result")


@attr.s(auto_attribs=True)
class InlineResponse2007Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inline_response_2007_result = cls(
            last=last,
        )
        ...
        inline_response_2007_result.additional_properties = additional_properties
        return inline_response_2007_result
