...
from ..models.get_closed_orders_response_200_closed_orders_closed_additional_property_descr import (
    GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyDescr,
)
from ..models.get_closed_orders_response_200_closed_orders_closed_additional_property_status import (
    GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyStatus,
)
from ..models.get_closed_orders_response_200_closed_orders_closed_additional_property_trigger import (
    GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetClosedOrdersResponse200ClosedOrdersClosedAdditionalProperty")


@attr.s(auto_attribs=True)
class GetClosedOrdersResponse200ClosedOrdersClosedAdditionalProperty:
    """
    Attributes:
        refid (Union[Unset, str]): Referral order transaction ID that created this order
        userref (Union[Unset, str]): User reference id
        status (Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyStatus]): Status of order
        ...
        descr (Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyDescr]): Order description
            info
        ...
        trigger (Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger]): Price signal used
            to trigger "stop-loss"
            "take-profit" "stop-loss-limit"
            "take-profit-limit" orders.
              * `last` is the implied trigger if this field is not set.
             Default: GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger.LAST.
    ...
    status: Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyStatus] = UNSET
    opentm: Union[Unset, float] = UNSET
    starttm: Union[Unset, float] = UNSET
    expiretm: Union[Unset, float] = UNSET
    descr: Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyDescr] = UNSET
    ...
    trigger: Union[
        Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger
    ] = GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger.LAST
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status: Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyStatus(_status)
        ...
        descr: Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyDescr]
        if isinstance(_descr, Unset):
            descr = UNSET
        else:
            descr = GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyDescr.from_dict(_descr)
        ...
        trigger: Union[Unset, GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger]
        if isinstance(_trigger, Unset):
            trigger = UNSET
        else:
            trigger = GetClosedOrdersResponse200ClosedOrdersClosedAdditionalPropertyTrigger(_trigger)
        ...
        get_closed_orders_response_200_closed_orders_closed_additional_property = cls(
            refid=refid,
            userref=userref,
            status=status,
            opentm=opentm,
        ...
        get_closed_orders_response_200_closed_orders_closed_additional_property.additional_properties = d
        return get_closed_orders_response_200_closed_orders_closed_additional_property
